...
public class MemberControllerTest {
   ...
   public void authenicateEmail() throws Exception {
	   mockMvc.perform(post("/member/mailauth")
			   .param("userId", "hdedlSpring")
			   .param("password", "12345qwe!!")
			   .param("email", "choayoung91@naver.com")
			   .param("tell", "010-4077-4444"))
	   .andDo(print());
   }
   ...
   public void joinImpl() throws Exception {
	   mockMvc.perform(get("/member/joinimpl/*")).andDo(print());
   }
