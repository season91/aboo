        ...
        <div class="container-fluid">
          <div class="row slider-text align-items-center justify-content-center" data-scrollax-parent="true">
            ...
            <div class="col-md-8 mt-5 text-center col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span><a href="${context }/myapt/parking">Parking</a></span> <span><a href="${context }/myapt/schedule">Schedule</a></span> <span><a href="${context }/myapt/institutions/institutions">Institutions</a></span>  <span class="mr-2"><a href="${context }/myapt/schedule">Schedule</a></span> <span class="mr-2"><a href="${context }/myapt/chat">Chat</a></span> </p>
    ...
    <section class="ftco-section">
    	<c:choose>
    		...
    		<c:otherwise>
			    ...
			    <div class="mt-5 mb-5 text-center">생성된 투표가 없습니다.</div>
