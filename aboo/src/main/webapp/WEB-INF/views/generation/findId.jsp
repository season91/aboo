			...
			<div class="row block-9 justify-content-center">
				<div class="col-md-6">
					<div class="form-group">
						<input type="text" class="form-control" id="building" name="building" placeholder="동">
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="num" name="num" placeholder="호">
					</div>
					<div class="form-group">
	...
	<script type="text/javascript">
      let certified = () => {
    	  let certifiedNum = document.querySelector("#certifiedNum").value;
  	  			...
  	  			fetch("/authenticationid?certifiedNum="+certifiedNum,{
  	  				method:"GET"
  	  			})
