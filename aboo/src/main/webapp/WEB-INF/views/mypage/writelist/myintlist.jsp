			    				...
			    				<table class="table">
								    ...
								    <tbody>
								      <c:forEach items="${board}" var="board">
								      	  <tr>
									        <td>${board.intPostNo}</td>
									        <td>인테리어</td>
									        <td><a href="/board/interior/intdetail?intPostNo=${board.intPostNo}" style="cursor: pointer; color: black;">${board.intTitle}</a></td>
									        <td>${board.intRegDate}</td>
									      </tr>
								      </c:forEach>
								    </tbody>
								  </table>
