                   ...
                   <div class="row block-9">
			          <div class="col-md-12">
			              ...
			              <div class="form-group">
			                ...
			                <input type="text" class="form-control" name="bTitle" id="bTitle" placeholder="제목을 입력하세요" required="required" value="${infoBoard.bTitle}">
			              </div>
			              <div class="form-group">
			                <textarea name="bContent" id="bContent" cols="30" rows="15" class="form-control" placeholder="내용을 입력하세요"  required="required" >${infoBoard.bContent}</textarea>
			              </div>
			               <div class="form-group">
